...
namespace Thmanyah.Cms.src.Thmanyah.Cms.Migrations.Cms
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresenterName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Thumbnail = table.Column<string>(type: "text", nullable: true),
                    EpisodeUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Episodes_ProgramId_Title",
                table: "Episodes",
                columns: new[] { "ProgramId", "Title" });
